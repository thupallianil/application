...
export default function QuoteList() {
  ...
  const handleDownload = (id) => navigate(`/quotes/${id}?action=download`);
  ...
  const filteredQuotes = quotes.filter((quote) => {
    ...
    if (sortKey === "amount" || sortKey === "total")
      return sortDir === "asc"
        ? parseFloat(a.amount || a.grand_total || 0) - parseFloat(b.amount || b.grand_total || 0)
        : parseFloat(b.amount || b.grand_total || 0) - parseFloat(a.amount || a.grand_total || 0);
        ...
        <table className="w-full text-left border-collapse whitespace-nowrap">
          <thead>
            <tr className="border-b border-[#c3c4c7]">
              ...
              {[
                { label: "Title", key: "quote" },
                { label: "Number", key: "quotation_id" },
                { label: "Client", key: "client_name" },
                { label: "Statuses", key: "status" },
                { label: "Created", key: "quoteDate" },
