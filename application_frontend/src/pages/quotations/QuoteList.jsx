                  ...
                  <tr key={q.id} className={`${idx % 2 !== 0 ? "bg-[#f9f9f9]" : "bg-white"} hover:bg-[#f0f0f1] border-b border-[#f0f0f0] group`}>
                    ...
                    <td className="p-[10px]">
                      <div className="flex gap-2">
                        <button onClick={() => window.open(`/quotes/${q.id}`, "_blank")} className="border border-[#2271b1] p-[3px] rounded-sm text-[#2271b1] bg-white hover:bg-[#f0f0f1]" title="Print / Download">
                          <FileText size={16} />
                        </button>
