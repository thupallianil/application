...
const API_URL = "http://127.0.0.1:8001/api/invoices/";
  ...
  return (
    <div className="space-y-6 bg-[#f0f0f1] min-h-screen p-4 md:p-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <NavLink to="/invoices/add" className="border border-blue-500 text-blue-600 bg-white hover:bg-blue-50 px-4 py-2 text-sm rounded cursor-pointer font-medium">
          Add New Invoice
        </NavLink>
      </div>
